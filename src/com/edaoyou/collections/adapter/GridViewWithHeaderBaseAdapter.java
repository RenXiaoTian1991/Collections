...
public abstract class GridViewWithHeaderBaseAdapter extends BaseAdapter {
	...
	public final View getView(int position, View view, ViewGroup viewGroup) {
		...
		int columnWidth = 0;
		if (viewGroup != null) {
			columnWidth = (viewGroup.getWidth() - viewGroup.getPaddingLeft() - viewGroup.getPaddingRight()) / mNumColumns;
		} else if (view != null) {
			columnWidth = (view.getWidth() - view.getPaddingLeft() - view.getPaddingRight()) / mNumColumns;
		}
